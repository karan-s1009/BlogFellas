        ...
        <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
            <div className='flex flex-col items-center justify-center'>
                <div className='w-full py-6 text-center'>
                    ...
                    <p className='font-light'>Decrypt your identity to enter the admin mainframe</p>
                </div>
                <form onSubmit={handleSubmit} className='mt-6 w-full sm:max-w-md text-gray-600'>
                    ...
                    <button type='submit' className='w-full py-3 font-medium bg-gradient-to-r from-[#E54450] to-[#5C000A] text-white hover:scale-105 rounded cursor-pointer transition-all'>Login</button>
                </form>
            </div>
        </div>
    </div>
